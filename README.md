...
![JaCoCo](https://img.shields.io/badge/JaCoCo-Code_Coverage-C0272D?logo=java&logoColor=white)
![Jakarta Persistence](https://img.shields.io/badge/Jakarta-Persistence_API-blue?logo=jakarta-ee&logoColor=white)
![Maven Failsafe](https://img.shields.io/badge/Maven_Failsafe-Integration_Tests-C71A36?logo=apache-maven&logoColor=white)
...
- **Microservices Architecture CA1:** REST API Assignment [ma-ca1](https://github.com/joeaoregan/TUS-26-MA-CA1-Guitar-Store-API/tree/ma-ca1)
...
- **Continuous Build and Delivery CA2:** Pipeline Assignment [cbd-ca2](https://github.com/joeaoregan/TUS-26-MA-CA1-Guitar-Store-API/tree/cbd-ca2)
